...
import mainImg from '../../public/wild01.jpg'
import Img02 from '../../public/wild02.jpeg'
import Img03 from '../../public/wild03.jpeg'
import Img04 from '../../public/wild04.jpg'
...
function page() {
  return (
    <div>
        ...
        <div className='p-12 flex flex-col lg:flex-row gap-6 lg:justify-center lg:gap-10'>
            <div><Image src={mainImg} alt='name' height={1000} width={1000} className='h-72 w-[98%] md:h-96 md:w-[90%] ml-[1%] md:ml-[5%] mt-32'/></div>
            <div className='text-justify w-[50%] lg:w-[50%] lg:mt-32  text-lg lg:text-xl'>Evolution is the process by which organisms change over time through variations in 
         ...
         <div className='h-[610px] sm:h-[570px] md:h-[490px] w-[450px] flex flex-col gap-4 md:w-[80%] lg:w-[450px] md:ml-[10%] lg:ml-0 border-2 border-gray-600 rounded-2xl
          p-3 mb-12 hover:bg-gray-100 hover:shadow-gray-500 hover:shadow-xl hover:duration-500 hover:delay-200'>
            ...
            <p className='text-justify'>The history of the theory of evolution dates back to ancient times, but it gained scientific foundation in the 
                ...
                and suggesting ideas of change. Jean-Baptiste Lamarck, in the early 1800s, proposed that organisms could pass on traits acquired during their lifetimes,</p><br/>
        </div>
        ...
        <Link href={'/'}><button className='border-gray-600 border-2 p-2 w-24 rounded-xl bg-gray-400 hover:bg-gray-300 hover:shadow-gray-500 hover:shadow-lg 
             font-bold hover:delay-200 hover:duration-500hover:text-black'>Back</button></Link>
