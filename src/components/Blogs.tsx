    ...
    <section className='flex flex-wrap sm:grid sm:grid-cols-1  md:grid-cols-2 lg:grid-cols-3 mt-6 w-[94%] gap-8 m-[5%] border-4 rounded-2xl p-5'>
        ...
        <div className='h-[610px] sm:h-[570px] w-[450px] md:w-[80%] lg:w-[450px] md:ml-[10%] lg:ml-0 border-2 border-gray-600 rounded-2xl
          p-3 mb-12 bg-yellow-200 hover:bg-yellow-100 hover:shadow-yellow-600 hover:shadow-xl hover:duration-500 hover:delay-200'>
            ...
            <p className='text-justify'>Oceanography is the scientific study of the ocean, its ecosystems, and the physical,
             ...
             wide range of topics, including ocean currents, waves, tides, marine organisms, and
             the oceans interaction with the atmosphere and seafloor.</p><br/>
             <Link href={'/oceanography'}><button className='border-gray-600 border-2 rounded-xl p-2 hover:bg-yellow-600 hover:shadow-yellow-700 hover:shadow-lg 
             font-bold hover:delay-200 hover:duration-500 hover:text-white'>Read More</button></Link>
        </div>
        ...
        <div className='h-[610px] sm:h-[570px] w-[450px] md:w-[80%] lg:w-[450px] md:ml-[10%] lg:ml-0 border-2 border-gray-600 rounded-2xl
          p-3 mb-12 bg-yellow-200 hover:bg-yellow-100 hover:shadow-yellow-600 hover:shadow-xl hover:duration-500 hover:delay-200'>
            ...
            <p className='text-justify'>Wildlife plays a crucial role in maintaining ecological balance, supporting biodiversity,
             ...
             <Link href={'/wildelife'}><button className='border-gray-600 border-2 rounded-xl p-2 hover:bg-yellow-600 hover:shadow-yellow-700 hover:shadow-lg 
             font-bold hover:delay-200 hover:duration-500 hover:text-white'>Read More</button></Link>
        </div>
        ...
        <div className='h-[610px] sm:h-[570px] w-[450px] md:w-[80%] lg:w-[450px] md:ml-[10%] lg:ml-0 border-2 border-gray-600 rounded-2xl
          p-3 mb-12 bg-yellow-200 hover:bg-yellow-100 hover:shadow-yellow-600 hover:shadow-xl hover:duration-500 hover:delay-200'>
            ...
            <p className='text-justify'>Insects play critical roles in ecosystems as pollinators, decomposers, and as part of the food chain.
             ...
             <Link href={'/entomology'}><button className='border-gray-600 border-2 rounded-xl p-2 hover:bg-yellow-600 hover:shadow-yellow-700 hover:shadow-lg 
             font-bold hover:delay-200 hover:duration-500 hover:text-white'>Read More</button></Link>
        </div>
        ...
        <div className='h-[610px] sm:h-[570px] w-[450px] md:w-[80%] lg:w-[450px] md:ml-[10%] lg:ml-0 border-2 border-gray-600 rounded-2xl
          p-3 mb-12 bg-yellow-200 hover:bg-yellow-100 hover:shadow-yellow-600 hover:shadow-xl hover:duration-500 hover:delay-200'>
            ...
            <p className='text-justify'>Evolution is the process by which species of organisms change over time through the gradual accumulation
             ...
             such as natural selection, mutation, genetic drift, and gene flow.</p><br/>
             <Link href={'/evolution'}><button className='border-gray-600 border-2 rounded-xl p-2 hover:bg-yellow-600 hover:shadow-yellow-700 hover:shadow-lg 
             font-bold hover:delay-200 hover:duration-500 hover:text-white'>Read More</button></Link>
        </div>
        ...
        <div className='h-[610px] sm:h-[570px] w-[450px] md:w-[80%] lg:w-[450px] md:ml-[10%] lg:ml-0 border-2 border-gray-600 rounded-2xl
          p-3 mb-12 bg-yellow-200 hover:bg-yellow-100 hover:shadow-yellow-600 hover:shadow-xl hover:duration-500 hover:delay-200'>
            ...
            vital functions like breathing, digestion, circulation, and reproduction, as well as how they respond
            to external stimuli and maintain homeostasis (internal balance).</p><br/>
            <Link href={'/physiology'}><button className='border-gray-600 border-2 rounded-xl p-2 hover:bg-yellow-600 hover:shadow-yellow-700 hover:shadow-lg 
             font-bold hover:delay-200 hover:duration-500 hover:text-white'>Read More</button></Link>
        </div>
        ...
        <div className='h-[610px] sm:h-[570px] w-[450px] md:w-[80%] lg:w-[450px] md:ml-[10%] lg:ml-0 border-2 border-gray-600 rounded-2xl
          p-3 mb-12 bg-yellow-200 hover:bg-yellow-100 hover:shadow-yellow-600 hover:shadow-xl hover:duration-500 hover:delay-200'>
            ...
            <p className='text-justify'>The field of parasitology also explores parasitic diseases that affect humans, animals, and plants,
             ...
             public health, veterinary medicine, agriculture, and ecology due to the significant impact parasites
             can have on populations and ecosystems.</p><br/>
             <Link href={'/parasitology'}><button className='border-gray-600 border-2 rounded-xl p-2 hover:bg-yellow-600 hover:shadow-yellow-700 hover:shadow-lg 
             font-bold hover:delay-200 hover:duration-500 hover:text-white'>Read More</button></Link>
        </div>
