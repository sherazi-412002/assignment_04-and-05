...
function Blogs() {
  return ( 
    ...
    <section className='flex flex-wrap sm:grid sm:grid-cols-1  md:grid-cols-2 lg:grid-cols-3 mt-6 w-[94%] gap-8 m-[3%] border-4 rounded-2xl p-5 justify-around'>
        ...
        {/* card01 */}
        <div className='h-[610px] md:h-[490px] sm:h-[570px] w-[450px] md:w-[90%] lg:w-[450px] md:ml-[5%] lg:ml-0 border-2 border-gray-600 rounded-2xl
          p-3 mb-12 hover:shadow-yellow-600 hover:shadow-xl hover:duration-500 hover:delay-200'>
            ...
            <p className='text-justify'>Oceanography is the scientific study of the ocean, its ecosystems, and the physical,
             ...
             <Link href={'/oceanography'}><button className='border-gray-600 border-2 rounded-xl p-2 bg-yellow-600 hover:shadow-gray-500  hover:shadow-lg 
             font-bold hover:delay-200 hover:duration-500 hover:text-black hover:bg-yellow-500'>Read More</button></Link>
        </div>
        ...
        <div className='h-[610px] md:h-[490px] sm:h-[570px] w-[450px] md:w-[90%] lg:w-[450px] md:ml-[5%] lg:ml-0 border-2 border-gray-600 rounded-2xl
          p-3 mb-12 hover:bg-yellow-100 hover:shadow-yellow-600 hover:shadow-xl hover:duration-500 hover:delay-200'>
            ...
            <p className='text-justify'>Wildlife plays a crucial role in maintaining ecological balance, supporting biodiversity,
             ...
             <Link href={'/wildelife'}><button className='border-gray-600 border-2 rounded-xl p-2 bg-yellow-600 hover:shadow-gray-500 hover:shadow-lg 
             font-bold hover:delay-200 hover:duration-500 hover:text-black hover:bg-yellow-500'>Read More</button></Link>
        </div>
        ...
        <div className='h-[610px] md:h-[490px] sm:h-[570px] w-[450px] md:w-[90%] lg:w-[450px] md:ml-[5%] lg:ml-0 border-2 border-gray-600 rounded-2xl
          p-3 mb-12 hover:bg-yellow-100 hover:shadow-yellow-600 hover:shadow-xl hover:duration-500 hover:delay-200'>
            ...
            <p className='text-justify'>Insects play critical roles in ecosystems as pollinators, decomposers, and as part of the food chain.
             ...
             <Link href={'/entomology'}><button className='border-gray-600 border-2 rounded-xl p-2 bg-yellow-600 hover:shadow-gray-500 hover:shadow-lg 
             font-bold hover:delay-200 hover:duration-500 hover:text-black hover:bg-yellow-500'>Read More</button></Link>
        </div>
        ...
        <div className='h-[610px] md:h-[490px] sm:h-[570px] w-[450px] md:w-[90%] lg:w-[450px] md:ml-[5%] lg:ml-0 border-2 border-gray-600 rounded-2xl
          p-3 mb-12 hover:bg-yellow-100 hover:shadow-yellow-600 hover:shadow-xl hover:duration-500 hover:delay-200'>
            ...
            <p className='text-justify'>Evolution is the process by which species of organisms change over time through the gradual accumulation
             ...
             <Link href={'/evolution'}><button className='border-gray-600 border-2 rounded-xl p-2 bg-yellow-600 hover:shadow-gray-500 hover:shadow-lg 
             font-bold hover:delay-200 hover:duration-500 hover:text-black hover:bg-yellow-500'>Read More</button></Link>
        </div>
        ...
        <div className='h-[610px] md:h-[490px] sm:h-[570px] w-[450px] md:w-[90%] lg:w-[450px] md:ml-[5%] lg:ml-0 border-2 border-gray-600 rounded-2xl
          p-3 mb-12 hover:bg-yellow-100 hover:shadow-yellow-600 hover:shadow-xl hover:duration-500 hover:delay-200'>
            ...
            <Link href={'/physiology'}><button className='border-gray-600 border-2 rounded-xl p-2 bg-yellow-600 hover:shadow-gray-500 hover:shadow-lg 
             font-bold hover:delay-200 hover:duration-500 hover:text-black hover:bg-yellow-500'>Read More</button></Link>
        </div>
        ...
        <div className='h-[610px] md:h-[490px] sm:h-[570px] w-[450px] md:w-[90%] lg:w-[450px] md:ml-[5%] lg:ml-0 border-2 border-gray-600 rounded-2xl
          p-3 mb-12 hover:bg-yellow-100 hover:shadow-yellow-600 hover:shadow-xl hover:duration-500 hover:delay-200'>
            ...
            <p className='text-justify'>The field of parasitology also explores parasitic diseases that affect humans, animals, and plants,
             ...
             <Link href={'/parasitology'}><button className='border-gray-600 border-2 rounded-xl p-2 bg-yellow-600 hover:shadow-gray-500 hover:shadow-lg 
             font-bold hover:delay-200 hover:duration-500 hover:text-black hover:bg-yellow-500'>Read More</button></Link>
        </div>
